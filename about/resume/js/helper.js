...
*/
/*
These are HTML strings which will be using JavaScript functions to
...
var HTMLprojectImage = '<img src="%data%" style="width:400px;height:300px;">';
...
function initializeMap() {
  ...
  */
  function locationFinder() {
    ...
    locations.push(data.bio.contacts.address);
    ...
    data.work.company.forEach(function(job){
